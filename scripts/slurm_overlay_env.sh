...
WANDB_CACHE_ROOT="${WANDB_CACHE_DIR:-$WANDB_ROOT/cache}"
WANDB_CONFIG_ROOT="${WANDB_CONFIG_DIR:-$WANDB_ROOT/config}"
WANDB_DATA_ROOT="${WANDB_DATA_DIR:-$WANDB_ROOT/data}"
...
export WANDB_CACHE_DIR="${WANDB_CACHE_DIR:-$WANDB_CACHE_ROOT}"
export WANDB_CONFIG_DIR="${WANDB_CONFIG_DIR:-$WANDB_CONFIG_ROOT}"
export WANDB_ARTIFACT_DIR="${WANDB_ARTIFACT_DIR:-$WANDB_ARTIFACT_ROOT}"
export WANDB_DATA_DIR="${WANDB_DATA_DIR:-$WANDB_DATA_ROOT}"
export MJLAB_WANDB_CACHE_DIR="${MJLAB_WANDB_CACHE_DIR:-$WANDB_ARTIFACT_DIR}"
